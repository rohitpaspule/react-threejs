...
export default function DashboardPage() {
  ...
  const [blogMarkers, setBlogMarkers] = useState<BlogMarkerData[]>([])
  ...
  useEffect(() => {
    ...
    // Load all blogs and create markers
    const blogs = getAllBlogs()
    const markers: BlogMarkerData[] = blogs.map((blog) => ({
